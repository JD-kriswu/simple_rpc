...
enum RpcErrorCode {
    ...
    RPC_ERROR_CONNECTION_CLOSED = 10,  //连接错误
    ...
    RPC_ERROR_SERVER_BUSY = 22,
     RPC_ERROR_RECV_BUFFER_OVERFLOW= 23,  //接收缓冲区溢出
     RPC_ERROR_RECV_CHECK_COMPLETE= 24,  //接收时完整性检查错误
     RPC_ERROR_PEER_CLOSED= 25,  //接收时对方关闭连接
     RPC_ERROR_SEND= 26,  //发送错误
     RPC_ERROR_SYS= 27,  //系统错误
